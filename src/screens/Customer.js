...
import { Dimensions, Image, StyleSheet, ScrollView, TouchableOpacity, Alert, ActivityIndicator } from "react-native";
...
class Customer extends Component {
    ...
    async getCustomer() {
        ...
        try {
            const response = await axios.get(`https://localhost:5001/api/customer/`, {
                headers: {
